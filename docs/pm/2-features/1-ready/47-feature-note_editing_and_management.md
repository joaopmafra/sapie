...
- [Story 55: Implement Note Content Editor](../../4-in-progress/55-story-note_content_editor.md) — textarea + autosave MVP; Phases 4–5 remaining
- [Story 66: Content body subdocument and client cache](../../3-stories/1-ready/66-story-content_body_subdocument_and_client_cache.md) — nested `body` + TanStack policy (after 55)
- [Story 67: Rich note content editor (MDXEditor)](../../3-stories/2-to-refine/67-story-rich_note_content_editor_mdx.md) — after 55 + 66
