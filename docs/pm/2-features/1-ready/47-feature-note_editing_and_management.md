...
- [Story 66: Content body subdocument and client cache](../../4-in-progress/66-story-content_body_subdocument_and_client_cache.md) — nested `body` + TanStack policy (after 55)
