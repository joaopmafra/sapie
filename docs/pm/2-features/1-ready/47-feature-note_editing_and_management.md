...
- [Story 71: Inline images in notes](../../5-done/71-story-inline_images_in_notes.md) — research Phase A (interim; superseded by 74)
- [Story 74: Dedicated attachment storage model](../../3-stories/1-ready/74-story-dedicated_attachment_storage_model.md) — subcollection refactor; **next after 71**
- [Story 72: Content body read via Service Worker](../../3-stories/2-to-refine/72-story-content_body_read_via_service_worker.md) — research Phases B–E; after 74
- [Story 73: Uniform body reads and attachment delete cascade](../../3-stories/2-to-refine/73-story-uniform_body_reads_and_image_orphan_cleanup.md) — research Phase F; after 72 + 64
- [Story 65: Note body concurrency and conflict resolution](../../3-stories/2-to-refine/65-story-note_body_concurrency_and_conflict_resolution.md) — full conflict UX; revision token introduced in 74
