...
- **Plain multiline note body** below the title (e.g. `<textarea>` or equivalent) with autosave and the save-status
  ...
  [Story 67: Rich note content editor (MDXEditor)](67-story-rich_note_content_editor_mdx.md).
...
- **Rich MDXEditor UI** — [Story 67](67-story-rich_note_content_editor_mdx.md).
...
- [Story 66](66-story-content_body_subdocument_and_client_cache.md) — body model + TanStack cache;
  scheduled **after** Story 55 (Phases 0–5) and **before** [Story 67](67-story-rich_note_content_editor_mdx.md)
  (preferred).
- [Story 67](67-story-rich_note_content_editor_mdx.md) — rich editor; depends on Story 55
...
- **Story 55:** plain **textarea** (or equivalent) for wiring, autosave, and save status — **not** `@mdxeditor/editor`
  (that is [Story 67](67-story-rich_note_content_editor_mdx.md)).
...
[Story 67](67-story-rich_note_content_editor_mdx.md).
...
- [Story 66 — body subdocument + cache](66-story-content_body_subdocument_and_client_cache.md) ·
  [Story 67 — Rich editor (MDXEditor)](67-story-rich_note_content_editor_mdx.md)
