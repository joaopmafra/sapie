...
- Note body stored in **Firebase Cloud Storage**; Firestore holds **metadata only** (`bodyUri`, `size`, `updatedAt`
  ...
  [Story 66](../4-in-progress/66-story-content_body_subdocument_and_client_cache.md) when that story lands).
...
- **Nested `body` subdocument + client cache policy** — [Story 66](../4-in-progress/66-story-content_body_subdocument_and_client_cache.md).
...
- [Story 66](../4-in-progress/66-story-content_body_subdocument_and_client_cache.md) — body model + TanStack cache;
...
- **Nested `body` metadata + TanStack cache policy** —
  [Story 66: Content body subdocument and client cache policy](../4-in-progress/66-story-content_body_subdocument_and_client_cache.md).
...
- [Story 66 — body subdocument + cache](../4-in-progress/66-story-content_body_subdocument_and_client_cache.md) ·
