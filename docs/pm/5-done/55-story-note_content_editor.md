...
- **Rich MDXEditor UI** — [Story 67](../4-in-progress/67-story-rich_note_content_editor_mdx.md).
...
- [Story 66](66-story-content_body_subdocument_and_client_cache.md) — body model + TanStack cache;
  scheduled **after** Story 55 (Phases 0–5) and **before** [Story 67](../4-in-progress/67-story-rich_note_content_editor_mdx.md)
  (preferred).
- [Story 67](../4-in-progress/67-story-rich_note_content_editor_mdx.md) — rich editor; depends on Story 55
...
- **Story 55:** plain **textarea** (or equivalent) for wiring, autosave, and save status — **not** `@mdxeditor/editor`
  (that is [Story 67](../4-in-progress/67-story-rich_note_content_editor_mdx.md)).
...
[Story 67](../4-in-progress/67-story-rich_note_content_editor_mdx.md).
...
- [Story 66 — body subdocument + cache](66-story-content_body_subdocument_and_client_cache.md) ·
  [Story 67 — Rich editor (MDXEditor)](../4-in-progress/67-story-rich_note_content_editor_mdx.md)
